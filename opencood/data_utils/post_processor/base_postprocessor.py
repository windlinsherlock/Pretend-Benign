...
class BasePostprocessor(object):
    ...
    def generate_gt_bbx(self, data_dict):
        ...
        for cav_id, cav_content in data_dict.items():
            ...
            object_bbx_center = object_bbx_center[:, [0, 1, 2, 5, 4, 3, 6]]             # hwl -> lwh

            gt_box3d_list.append(object_bbx_center)
            gt_box3d_corner_list.append(projected_object_bbx_corner)
        ...
        gt_box3d_corner_list = torch.vstack(gt_box3d_corner_list)
        ...
        gt_box3d_corner_list = gt_box3d_corner_list[gt_box3d_selected_indices]

        # filter the gt_box to make sure all bbx are in the range
        mask = \
            box_utils.get_mask_for_boxes_within_range_torch(gt_box3d_corner_list)

        gt_box3d_tensor = gt_box3d_tensor[mask].float()
